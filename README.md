...
* **Due date: 11:59pm, 12/04/2024**
* Questions to: steve97@snu.ac.kr
...
You will need to implement this feature in `QuadProbeHashTable::get_next_pos()`.
...
In `04-hashtable` directory, you run the following commands to compile your own implementation.

```
$ pwd
/xxx/xxx/xxx/04-hashtable
$ mkdir build
$ cd build
$ cmake ../
$ make
...
Submit the *hash_slot.hpp* and *hash_table.hpp* file via ETL system. 

The format of file name should be:

*hash_slot_{student_id}.hpp* 

*hash_table_{student_id}.hpp*
